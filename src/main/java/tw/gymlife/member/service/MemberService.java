...
public class MemberService {
	...
	public Member memberUpdate(int userId, String userAccount, String userName, String userGender, String userAddress,
			String userTel, String userEmail, Date userBirthDay) {
