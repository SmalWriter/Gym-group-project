...
public class CourseController_Back {
	...
	public List<CoachBean> insertCourseCoach(@RequestParam String coachName, @RequestParam String coachNickName,
			@RequestParam String coachPhoneNumber, @RequestParam String coachEmail, @RequestParam String coachBirthday,
			@RequestParam Integer coachHeight, @RequestParam Integer coachWeight, @RequestParam String coachIntroduce,
			@RequestParam("coachImg") MultipartFile image, Model m) throws IOException {
...
//		return "redirect:/course/coach";
	...
	public CoachBean selectCoachById(@RequestParam Integer coachId) {
	...
	public List<CoachBean> updateCourse(@RequestParam Integer coachId, @RequestParam String coachName,
			@RequestParam String coachNickName, @RequestParam String coachPhoneNumber, @RequestParam String coachEmail,
			@RequestParam String coachBirthday, @RequestParam Integer coachHeight, @RequestParam Integer coachWeight,
			@RequestParam String coachIntroduce, Model m) {
		chservice.updateCourseCoach(coachId, coachName, coachNickName, coachPhoneNumber, coachEmail, coachBirthday,
				coachWeight, coachHeight, coachIntroduce);
		return selectAllCourseajax();
	}
	...
	public List<CoachBean> deleteCourse(@RequestParam Integer coachId, Model m) {
	...
	public List<CoachBean> updateCourseImg(@RequestParam Integer coachId, @RequestParam("coachImg") MultipartFile image)
			throws IOException {
	...
	public List<CourseDTO> insertCourse(@RequestParam Integer coachId, @RequestParam String courseName,
			@RequestParam int courseCost, @RequestParam String courseIntroduce, MultipartHttpServletRequest request,
...
//				System.out.println(cbean.getCoach().getCoachId());
	...
	public CourseDTO selectCourseById(@RequestParam Integer courseId) {
	...
	public List<CourseDTO> updateCourse(@RequestParam Integer coachId, @RequestParam Integer courseId,
			@RequestParam String courseName, @RequestParam Integer courseCost, @RequestParam String courseIntroduce,
			Model m) {
		CoachBean chbean = chservice.selectCoachById(coachId);
	...
	public List<CourseDTO> deleteCourseById(@RequestParam Integer courseId, Model m) {
...
//		return selectAllCourse(m);
	...
	public CourseDTO deleteCourseImg(@RequestParam Integer imageId, @RequestParam Integer courseId) {
	...
	public CourseDTO insertCourseImg(@RequestParam Integer courseId, @RequestParam("courseImg") MultipartFile image)
			throws IOException {
	...
	public List<CourseDTO> updateCorder(@RequestParam Integer corderId, @RequestParam Integer corderQuantity,
	...
	public List<CourseDTO> deleteCorder(@RequestParam Integer corderId) {
	 ...
	 * //查詢教練圖片
	 * 
	 * @GetMapping("/coachImage/{courseId}") public ResponseEntity<byte[]>
	 * coachImage(@PathVariable Integer courseId){ ImageBean ibean =
	 * iservice.findCoachImg(courseId); byte[] photoFile = ibean.getImageData();
	 * 
	 * HttpHeaders headers = new HttpHeaders();
	 * headers.setContentType(MediaType.IMAGE_JPEG); //檔案, header, HttpStatus return
	 * new ResponseEntity<byte[]>(photoFile,headers,HttpStatus.OK); }
	 */
}
